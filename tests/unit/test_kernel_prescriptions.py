...
ROW_PLUS = frozenset(
    {
        ...
        "quark_pdf_cg_gt_msbar_nlo_rgr_im",
        "quark_pdf_cg_gtg5_msbar_nlo",
        "quark_pdf_cg_gtg5_msbar_nlo_rgr_im",
        "quark_pdf_cg_gz_msbar_nlo",
        "quark_pdf_cg_gz_msbar_nlo_rgr_im",
        "quark_pdf_cg_gzg5_msbar_nlo",
        "quark_pdf_cg_gzg5_msbar_nlo_rgr_im",
    }
)
