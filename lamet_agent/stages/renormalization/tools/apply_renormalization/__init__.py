...
def run(context: ToolContext) -> dict[str, object]:
    ...
    if strategy == "self_renormalization":
        ...
        try:
            ...
            raise ValueError("self-renormalization supports only PDF or DA ZMSbar conversion") from exc
    ...
    summary = {
        ...
        "decisions": {"scheme": scheme, "strategy": strategy, "normalization": bool(params["normalization"])},
