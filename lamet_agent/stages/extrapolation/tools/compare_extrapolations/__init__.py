...
def run(context: ToolContext, *, candidate_ids: list[str]) -> dict[str, object]:
    ...
    return {
        "summary": "selected the single authored extrapolation candidate",
        "metrics": {"candidate_ids": candidate_ids, "weights": [1.0], "max_between_model_sdev": 0.0},
        "state_keys": ["extrapolation_comparison", "extrapolation_selected_data"],
        "artifacts": [],
    }
