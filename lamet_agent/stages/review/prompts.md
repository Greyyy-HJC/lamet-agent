...
SVG artifact paths. Use the injected manifest contract for optional literature
settings. The requested report language is generated directly. SVG paths are
provenance only, and figure statements must be grounded in report text and
NetCDF summaries.
