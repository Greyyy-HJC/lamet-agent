<!-- lamet-agent formula cache; kernel=CG_gz_quark_PDF_ratio_NLO; arxiv=2602.11283; equations=Eq. (2.16) with the gamma^z shift of Eq. (2.15); digest=cf4ae0940b07c996; paper_used=true -->
