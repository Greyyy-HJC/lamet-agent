<!-- lamet-agent formula cache; kernel=quark_pdf_cg_gz_msbar_nlo_rgr_im; arxiv=2209.01236; equations=App. 'A Method Solving RG Equation' (Eq. matchingRGI); digest=6d40d7cd2b353b29; paper_used=true -->
