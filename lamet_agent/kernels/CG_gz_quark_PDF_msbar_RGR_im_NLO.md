<!-- lamet-agent formula cache; kernel=CG_gz_quark_PDF_msbar_RGR_im_NLO; arxiv=2209.01236; equations=App. 'A Method Solving RG Equation' (Eq. matchingRGI); digest=6d40d7cd2b353b29; paper_used=true -->
