<!-- lamet-agent formula cache; kernel=quark_da_gi_gtg5_ratio_nlo; arxiv=2212.14415; equations=Eq. (4.15) V_qq,h (the gamma^t gamma_5 coefficient), with the ratio-scheme Wilson-line term 3/(2|x-y|) (the z_s -> infinity limit of the hybrid Si term; see V_qq_rto); digest=8026c977e30dceea; paper_used=true -->
