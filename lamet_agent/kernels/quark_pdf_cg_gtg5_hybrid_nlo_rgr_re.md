<!-- lamet-agent formula cache; kernel=quark_pdf_cg_gtg5_hybrid_nlo_rgr_re; arxiv=2209.01236; equations=App. 'A Method Solving RG Equation' (Eq. matchingRGI); digest=99dd65b339287a8f; paper_used=true -->
