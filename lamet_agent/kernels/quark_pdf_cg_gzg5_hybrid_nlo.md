<!-- lamet-agent formula cache; kernel=quark_pdf_cg_gzg5_hybrid_nlo; arxiv=2602.11283; equations=Eqs. (2.19)-(2.20) with the gamma^z shift of Eq. (2.15); digest=585da36fd1bce6bf; paper_used=true -->
