<!-- lamet-agent formula cache; kernel=CG_gtg5_quark_PDF_hybrid_RGR_re_NLO; arxiv=2209.01236; equations=App. 'A Method Solving RG Equation' (Eq. matchingRGI); digest=99dd65b339287a8f; paper_used=true -->
