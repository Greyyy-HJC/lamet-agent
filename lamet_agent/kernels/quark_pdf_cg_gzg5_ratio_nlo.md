<!-- lamet-agent formula cache; kernel=quark_pdf_cg_gzg5_ratio_nlo; arxiv=2602.11283; equations=Eq. (2.16) with the gamma^z shift of Eq. (2.15); digest=fd954ef187d8a1ff; paper_used=true -->
