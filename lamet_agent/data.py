...
def format_gvar(values: Any) -> str:
    """Format every gvar element compactly without NumPy ellipsis truncation."""
    return numpy.array2string(numpy.asarray(values, dtype=object), threshold=numpy.inf, separator=" ")
