...
If analysis_mode is 2pt_ratio, call fit_da_2pt_ratio_grid directly with the
configured pt2_window or first pt2_windows entry. This mode implements
C2(z,P,t)/C2(0,P,t)=H_B^m(z)*(1+c_z exp(-DeltaE t))/(1+c_0 exp(-DeltaE t))
from arXiv:2201.09173 Eq. (2); it has no 3pt data, tsep, tau_cut, or current
operator. Finish with the NetCDF and diagnostic PDF paths.
