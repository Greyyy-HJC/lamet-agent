...
2. Call tune_bare_matrix with that scale. Compare the returned candidates across
   nstate, fit_strategy, windows, Q, chi2/dof, and logGBF.
3. Call fit_bare_matrix_grid with the selected scalar nstate and fit_strategy,
   the same scale, and either the selected pt2_window/pt3_window or
