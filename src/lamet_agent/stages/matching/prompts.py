...
2. load_quasi_pdf on metadata.matching.quasi_input (default the Fourier artifact artifacts/fourier_result.nc). It auto-detects the Fourier EnsembleData NetCDF artifact and takes the requested component; pass component='im' only if the quasi-PDF lives in the imaginary channel. Stores x_ls and quasi_ed.
