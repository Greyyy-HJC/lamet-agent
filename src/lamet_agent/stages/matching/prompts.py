...
2. Call build_matching_kernel without overriding kernel_id, pz_gev, mu, or zs_fm;
...
4. Call plot_matched_pdf and report_matching_result, then finish with the NetCDF,
   PDF, and bilingual report paths.
""".strip()
